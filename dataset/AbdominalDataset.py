...
class AbdominalDataset(BasicDataset):
    def __init__(self, opt, mode, transforms, base_dir, domains: list, **kwargs):
        ...
        """
        self.dataset_key = "abdominal"
        super(AbdominalDataset, self).__init__(opt, mode, transforms, base_dir, domains, LABEL_NAME=LABEL_NAME,
